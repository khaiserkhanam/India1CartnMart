...
(function( $ ) {
    ...
    // hamburger
let header_list=document.getElementById("header_list");
let menuBars=document.getElementById("menuBars");
menuBars.addEventListener("click",()=>{
    if(header_list.style.width=='0%'){
        header_list.style.width='70%';
        menuBars.classList="fas fa-times"
    }else{
        header_list.style.width='0%';
        menuBars.classList="fas fa-bars"
    }
})
